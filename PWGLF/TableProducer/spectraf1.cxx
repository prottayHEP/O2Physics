...
struct spectraf1 {
  ...
  Configurable<float> ConfPtCutsF1Proton{"ConfPtCutsF1Proton", 0.15, "Particle Momentum selections"};
  Configurable<float> ConfTrkEtaF1Proton{"ConfTrkEtaF1Proton", 0.8, "Eta"};
  ...
  Configurable<float> ConfTrkTPCfClsF1Proton{"ConfTrkTPCfClsF1Proton", 0.8, "Minimum fraction of crossed rows over findable clusters"};
  ...
  Configurable<bool> ConfTrkTPCRefit{"ConfTrkTPCRefit", true, "True: require TPC refit"};
  Configurable<bool> ConfTrkITSRefit{"ConfTrkITSRefit", true, "True: require ITS refit"};

  // Configs for V0
  Configurable<float> ConfV0PtMin{"ConfV0PtMin", 0.f, "Minimum transverse momentum of V0"};
  Configurable<float> ConfV0DCADaughMax{"ConfV0DCADaughMax", 0.8f, "Maximum DCA between the V0 daughters"};
  Configurable<float> ConfV0CPAMin{"ConfV0CPAMin", 0.98f, "Minimum CPA of V0"};
  ...
  PROCESS_SWITCH(spectraf1, processF1Proton, "Process for trigger", true);
};
